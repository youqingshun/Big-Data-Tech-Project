### This is the version with the only time and values
...
vals = ['EnvironmentStation', 'RWISstation','MeteoStation', 'Trafficstation','traffic', 
'TrafficSensor','TrafficStreetFactor', 'Streetstation', 'LinkStation', 'BluetoothStation',
'ParkingStation', 'ParkingSensor']
...
for i in newinfo:  ## newinfo lacks one values: TrafficStation
    print("\t")
    # print(i)
