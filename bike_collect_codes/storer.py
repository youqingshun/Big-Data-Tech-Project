...
if __name__ == "__main__":
    ...
    arg_parser.add_argument("-Mu", "--mqtt_user", required=False, default= "admin", type=str, help="MQTT username")
    arg_parser.add_argument("-Mp", "--mqtt_password", required=False, type=str, default= " 123456", help="MQTT password")
    arg_parser.add_argument("-Mh", "--mqtt_host", required=False, type=str, default= "127.0.0.1", help="MQTT host")
