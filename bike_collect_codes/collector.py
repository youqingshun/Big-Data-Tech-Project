...
from station import Station, SQLiteStationManager, MySQLStationManager
...
if __name__ == "__main__":
    ...
    while True:
        ...
        for station in stations:
            client.publish(f"bdt-2021/{station.city}/station", json.dumps(station.to_repr()), qos=0, retain=True)  # we can check use the clause : bdt-2021/#q  
